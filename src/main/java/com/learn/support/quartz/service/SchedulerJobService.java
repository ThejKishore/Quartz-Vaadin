package com.learn.support.quartz.service;


import com.learn.support.data.entity.SamplePerson;
import com.learn.support.quartz.component.JobScheduleCreator;
import com.learn.support.quartz.entity.SchedulerJobInfo;
import com.learn.support.quartz.job.SampleCronJob;
import com.learn.support.quartz.job.SimpleJob;
import com.learn.support.quartz.repository.SchedulerRepository;
...
//Pageable pageable
	...
	public Page<SchedulerJobInfo> list(Pageable pageable) {
	...
	public Optional<SchedulerJobInfo> get(UUID id) {
